#ifndef RFADEVICEQUERY_H_
#define RFADEVICEQUERY_H_
...
class RFADeviceQuery: public QDialog {
	Q_OBJECT

public:
	explicit RFADeviceQuery(QWidget *parent = nullptr);
